              ...
              >
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-white text-2xl font-bold font-sans m-0">
                    SAI PRASAD MAHENHDHRAKAR
                    <span className="text-[#00CFFF]">.</span>
                  </h3>
                </div>
                <p className="text-[#b0b0b0] text-base leading-relaxed mb-6 font-mono">
                  Crafting scalable <span className="text-[#00CFFF]">experiences</span> experiences with clean code and thoughtful design. Full-Stack Developer skilled in Java, Spring Boot, SQL, and Angular, with a growing interest in AI-driven solutions.
                </p>
                ...
                >
                  ...
                  <div className="space-y-4">
                    <div className="text-secondary text-sm mb-4">
                      Senior Software Engineer at Capgemini | Java-AWS Cloud Engineer
                    </div>
            ...
            >
              ...
              <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <p className="text-[#b0b0b0] text-sm font-mono">
                  © {currentYear} SAI PRASAD MAHENDHRAKAR <span className="text-[#00CFFF]">|</span> Portfolio. All rights reserved.
                </p>
