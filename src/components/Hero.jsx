      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 flex flex-col items-center justify-center h-full">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            <a href="/Sai_Prasad_Java_SpringBoot_Resume.pdf" download className="relative overflow-hidden bg-transparent border-2 border-[#915EFF] text-[#915EFF] hover:bg-[#915EFF] hover:text-[#18122B] font-mono px-8 py-3 rounded-lg text-lg font-semibold shadow-lg transition-all duration-300 group">
